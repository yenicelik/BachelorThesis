...
\citep{UCBRegretProof} show a proof, that for a certain tuning of the parameter $\beta$, the acquisition function is guaranteed to find the best configuration after a certain number of data-samples taken.

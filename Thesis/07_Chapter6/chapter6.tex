...
I set the number of restarts to $14$.
Notice that the Tripathy approximation is slightly more accurate than the BORING approximation. 
This is because one of Tripathy's initial starting points were well selected, such that algorithm 3 ran many times before the relative loss terminated the algorithm.

...
\begin{figure}[H]
  \centering
      \includegraphics[width=0.5\textwidth]{reference_W_true/Sinusoidal5D}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[width=\textwidth]{W_hat_tripathy/Sinusoidal5D_1D}
        \label{fig:tiger}
        \caption{Run 2}
    \end{subfigure}   
...
\begin{figure}[H]
  \centering
      \includegraphics[width=0.5\textwidth]{W_hat_tripathy/Sinusoidal5D_2D}
...
\center
    ...
    \begin{subfigure}[b]{0.40\textwidth}
        ...
        \label{fig:tiger}
               \caption{The momentary $W$ from tripathy's algorithm, and it's log-likelihood w.r.t. to the GP and the so-far collected data}
    \end{subfigure}   
 \vskip\baselineskip
         \centering
             \begin{subfigure}[b]{0.40\textwidth}

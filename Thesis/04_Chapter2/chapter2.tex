...
This quantity is also known as the \textbf{Stiefel manifold}, where $d$ is the found effective dimension of the function, and $D$ is the real input dimension to the function. \\
